...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.48\textwidth}
            ...
            fast or so quiet or so efficent. The most important in our performance requirements
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.48\textwidth}
            Physical Requirements are like the other requirements and define the physcial
            atributes that define success in solving our product's problem. The most important here
